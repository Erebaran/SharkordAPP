...
contextBridge.executeInMainWorld({
    ...
    func: () => {
        ...
        // ==================================================
        // DEVICES — SELETOR DE CODEC DE ÁUDIO
        // ==================================================

        const AUDIO_CODEC_STORAGE_KEY =
            "__sharkord_audio_codec_preference";


        const AUDIO_CODEC_PANEL_ID =
            "__sharkord_audio_codec_panel";


        let lastNegotiatedAudioCodec =
            null;


        function getAudioCodecPreference() {

            try {

                const value =
                    localStorage.getItem(
                        AUDIO_CODEC_STORAGE_KEY
                    );
        ...
        function setAudioCodecPreference(
            value
        ) {
            ...
            console.log(
                `[Audio] Preferência de codec alterada para: ${normalized}`
            );


            updateCodecPanelStatus();
        }
        ...
        function isDevicesTabActive(
            ...
            /*
             * Fallback: se a página atualmente exibe textos típicos
             * da seção Devices, consideramos a tab ativa.
             */
            const bodyText =
                normalizeUiText(
                    document.body
        ...
        function findDevicesContentContainer(
            tab
        ) {
        ...
        function updateCodecPanelStatus() {
            ...
            const negotiated =
                panel.querySelector(
                    "[data-sharkord-codec-negotiated]"
                );
                ...
                >
                    ...
                    >
                        ...
                        <div
                            ...
                            "
                        >
                            Escolha como o Sharkord Desktop negocia o codec de voz.
                        </div>
                    </div>
        ...
        function mountCodecPanelInDevices() {
            ...
            codecPanel.style.display =
                "block";


            if (
                codecPanel.parentElement !==
                container
            ) {
        ...
        let codecUiScanQueued =
            false;


        function scheduleCodecUiScan() {

            if (codecUiScanQueued) {
                return;
            }
        ...
        // ==================================================
        // OPUS — CODEC PREFERENCIAL DE ÁUDIO
        // ==================================================

        function preferOpusForTransceiver(
            transceiver
        ) {
            ...
            try {
                ...
                if (
                    ...
                    "function" ||
                    typeof RTCRtpSender?.getCapabilities !==
                    "function"
                ) {
                ...
                if (
                    ...
                    console.warn(
                        "[Audio] Opus não apareceu nas capabilities do Chromium."
                    );
                ...
                logData(
                    "[Audio] Opus definido como codec preferencial",
                    {
                        opus:
                            opusCodecs.map(
                                codec => ({
        ...
        function preferOpusForPeerConnection(
            peerConnection
        ) {
            ...
            try {
                ...
                warnData(
                    "[Audio] Falha ao procurar transceivers para Opus",
                    {
                        error:
                        caughtError
                    }
        ...
        async function logNegotiatedAudioCodec(
            peerConnection,
            reason =
            "manual"
        ) {
                ...
                if (
                    ...
                    if (
                        ...
                        const channels =
                            activeCodec
                                .channels
                                ? ` · ${activeCodec.channels === 1
                                    ? "Mono"
                                    : activeCodec.channels === 2
                                        ? "Stereo"
                                        : `${activeCodec.channels} canais`
                                }`
                                : "";


                        lastNegotiatedAudioCodec =
                            `${codecName}${rate}${channels}`;
        ...
        async function createVideoBridge(
            ...
            console.log(
                "[ScreenShare] criando Stable Canvas 60 FPS - Fast Start."
            );
        ...
        async function restartNativeScreenShareForSwitch() {
            ...
            try {
                ...
                console.warn(
                    "[ScreenShare] currentSession ausente; usando fallback parar/reabrir."
                );
                ...
                if (!stopButton) {
                    ...
                    throw new Error(
                        "Botão nativo de screen share não encontrado."
                    );
                }
                ...
                /*
                 * Aqui NÃO chamamos preventDefault: precisamos deixar
                 * o próprio Sharkord encerrar a transmissão atual.
                 */
                stopButton.click();
                ...
                while (
                    ...
                    /*
                     * Em alguns renders o React reutiliza o mesmo nó.
                     * Depois de ~250 ms aceitamos o botão reutilizado.
                     */
                    if (
                        candidate &&
                        candidate.isConnected &&
                ...
                if (!startButton) {
                    ...
                    throw new Error(
                        "Botão para reabrir screen share não apareceu."
                    );
                }


                console.log(
                    "[ScreenShare] reabrindo compartilhamento pelo botão nativo."
                );
                ...
                errorData(
                    "[ScreenShare] fallback de troca falhou",
                    caughtError
                );
        ...
        async function switchShareSource() {
            ...
            if (
                ...
                await restartNativeScreenShareForSwitch();
        ...
        function bindSwitchAction(
            ...
            button.addEventListener(
                ...
                event => {
                    ...
                    console.log(
                        "[ScreenShare UI] botão TROCAR clicado.",
                        {
                            hasCurrentSession:
                                !!currentSession,
